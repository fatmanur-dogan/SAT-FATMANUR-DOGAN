...
func on_game_ready() -> void:
	self.set_text_with_color(tr("Hazır olun!"))
...
func on_player_died() -> void:
	self.set_text_with_color(tr("Öldünüz!"), self.player_died_color)


func on_game_over() -> void:
	self.set_text_with_color(tr("Oyun Bitti!"), self.game_over_color)


func on_level_cleared() -> void:
	var text: String = tr("Seviye tamamlandı!\nOynadığınız için teşekkürler!")
